public class GaussJordanElimination {
    ...
    public static boolean isNotFeasible(final Matrix matrix,
        ...
        Utils.checkNotNaN(epsilon, "The input epsilon is NaN.");
        Utils.checkNotInfinite(epsilon, "The input epsilon is infinite: " + epsilon);
        Utils.checkNotNegative(epsilon, "The input epsilon is negative: " + epsilon);
    ...
    private GaussJordanElimination(final double[][] m, final double epsilon) {
        Utils.checkNotNull(m, "The input matrix is null.");
        Utils.checkNotNaN(epsilon, "The input epsilon is NaN.");
        Utils.checkNotInfinite(epsilon, "The input epsilon is infinite: " + epsilon);
        Utils.checkNotNegative(epsilon, "The input epsilon is negative: " + epsilon);
    ...
    private static void checkFactor(final double factor) {
        Utils.checkNotNaN(factor, "The factor is NaN.");
        Utils.checkNotInfinite(factor, "The factor is infinite: " + factor);
    }
